...
import (
	...
	"github.com/lybeat/go-gin-example/service/article_service"
...
func GetArticle(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusOK, e.ERROR_GET_DATA_FAIL, nil)
		return
	}
...
type AddArticleForm struct {
	...
	CoverUrl  string `form:"cover_url" valid:"Required;MaxSize(255)"`
...
func AddArticle(c *gin.Context) {
	...
	if err != nil {
		appG.Response(http.StatusInternalServerError, e.ERROR_EXIST_DATA, nil)
		return
	}
...
const QRCODE_URL = "https://github.com/lybeat"
